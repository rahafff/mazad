...
//
//     final searchResponseEntity = searchResponseEntityFromJson(jsonString);

import 'dart:convert';

SearchResponseEntity searchResponseEntityFromJson(String str) => SearchResponseEntity.fromJson(json.decode(str));

String searchResponseEntityToJson(SearchResponseEntity data) => json.encode(data.toJson());
...
class SearchResponseEntity {
  ...
  factory SearchResponseEntity.fromJson(Map<String, dynamic> json) => SearchResponseEntity(
