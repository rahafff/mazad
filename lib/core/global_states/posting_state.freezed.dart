...
/// @nodoc
abstract class $PostingStateCopyWith<T, $Res> {
  factory $PostingStateCopyWith(
          PostingState<T> value, $Res Function(PostingState<T>) then) =
      _$PostingStateCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$PostingStateCopyWithImpl<T, $Res>
    implements $PostingStateCopyWith<T, $Res> {
  _$PostingStateCopyWithImpl(this._value, this._then);

  final PostingState<T> _value;
  // ignore: unused_field
  final $Res Function(PostingState<T>) _then;
}
...
/// @nodoc
class __$$IdleCopyWithImpl<T, $Res> extends _$PostingStateCopyWithImpl<T, $Res>
...
abstract class Idle<T> implements PostingState<T> {
...
class __$$LoadingCopyWithImpl<T, $Res>
    extends _$PostingStateCopyWithImpl<T, $Res>
...
abstract class Loading<T> implements PostingState<T> {
...
class _$Success<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'PostingState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements PostingState<T> {
...
/// @nodoc
class __$$ErrorCopyWithImpl<T, $Res> extends _$PostingStateCopyWithImpl<T, $Res>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'PostingState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements PostingState<T> {
