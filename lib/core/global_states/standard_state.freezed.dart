...
abstract class $StandardStateCopyWith<T, $Res> {
  factory $StandardStateCopyWith(
      ...
      _$StandardStateCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$StandardStateCopyWithImpl<T, $Res>
    implements $StandardStateCopyWith<T, $Res> {
  _$StandardStateCopyWithImpl(this._value, this._then);

  final StandardState<T> _value;
  // ignore: unused_field
  final $Res Function(StandardState<T>) _then;
}
...
class __$$LoadingCopyWithImpl<T, $Res>
    extends _$StandardStateCopyWithImpl<T, $Res>
...
abstract class Loading<T> implements StandardState<T> {
...
abstract class Success<T> implements StandardState<T> {
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'StandardState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements StandardState<T> {
