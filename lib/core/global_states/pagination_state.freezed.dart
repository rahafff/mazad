...
class _$Success<T> implements Success<T> {
  const _$Success(final List<T?> data, this.currentPage) : _data = data;
  ...
  @override
  String toString() {
    return 'PaginationState<$T>.success(data: $data, currentPage: $currentPage)';
  }
...
abstract class Success<T> implements PaginationState<T> {
  const factory Success(final List<T?> data, final int currentPage) =
      _$Success<T>;
