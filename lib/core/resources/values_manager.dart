...
class AppSize {
  ...
  static   double settingsIconSize=6.w;
  static  double currencyIconSize=4.w;

  static double textFieldBorderRadius = 10.w;
  static double screenSize(context){
    double screenSize=MediaQuery.of(context).size.height*MediaQuery.of(context).size.width;
    return screenSize;
  }
}
